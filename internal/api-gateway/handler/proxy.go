...
// @Success 201 {object} service.UserInfo
...
// @Produce json
// @Param Authorization header string true "Bearer Token"
// @Param request body service.UpdateUserProfileRequest true "Profile Data"
// @Success 200 {object} service.UserInfo
...
// @Accept json
// @Produce json
// @Param request body service.GenerateQRRequest true "QR Data"
// @Success 200 {object} service.GenerateQRResponse
...
// @Accept json
// @Produce json
// @Param request body service.ScanQRRequest true "Scan Data"
// @Success 200 {object} service.ScanQRResponse
...
// @Success 200 {object} service.GetAttendancesResponse
...
// @Accept json
// @Produce json
// @Param request body service.ManualAttendanceRequest true "Attendance Data"
// @Success 201 {object} service.AttendanceVO
...
// @Accept json
// @Produce json
// @Success 200 {object} service.AttendanceStatistics
...
// @Accept json
// @Produce json
// @Param request body service.CreateScheduleRequest true "Schedule Data"
// @Success 201 {object} service.ScheduleVO
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetSchedulesResponse
...
// @Success 200 {object} service.ScheduleVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateCourseRequest true "Course Data"
// @Success 201 {object} service.CourseVO
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetCoursesResponse
...
// @Success 200 {object} service.CourseVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateClassRequest true "Class Data"
// @Success 201 {object} service.ClassVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateBroadcastRequest true "Broadcast Data"
// @Success 201 {object} service.BroadcastVO
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetBroadcastsResponse
...
// @Success 200 {object} service.BroadcastVO
...
// @Accept json
// @Produce json
// @Param request body service.SendNotificationRequest true "Notification Data"
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetNotificationsResponse
...
// @Accept json
// @Produce json
// @Param request body service.RegisterDeviceTokenRequest true "Device Token"
// @Success 201 {object} map[string]string
...
// @Produce json
// @Param request body service.GenerateQRRequest true "QR Data"
// @Success 201 {object} service.GenerateQRResponse
...
// @Accept json
// @Produce json
// @Param request body service.ValidateQRRequest true "Validation Data"
// @Success 200 {object} service.ValidateQRResponse
...
// @Accept json
// @Produce json
// @Success 200 {object} service.GenerateAccessQRResponse
...
// @Accept json
// @Produce json
// @Param request body service.ValidateGateQRRequest true "Gate Data"
// @Success 200 {object} service.ValidateGateQRResponse
...
// @Accept json
// @Produce json
// @Param request body service.CreateEventRequest true "Event Data"
// @Success 201 {object} service.EventVO
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetEventsResponse
...
// @Produce json
// @Param limit query int false "Limit"
// @Success 200 {object} []service.EventVO
...
// @Accept json
// @Produce json
// @Param request body service.TapInRequest true "Tap In Data"
// @Success 200 {object} service.LocationHistoryVO
...
// @Accept json
// @Produce json
// @Param request body service.TapOutRequest true "Tap Out Data"
// @Success 200 {object} service.LocationHistoryVO
...
// @Accept json
// @Produce json
// @Success 200 {object} service.CheckInStatusVO
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetLocationHistoryResponse
...
// @Accept json
// @Produce json
// @Param request body service.ValidateLocationRequest true "Location Data"
// @Success 200 {object} service.ValidateLocationResponse
...
// @Accept json
// @Produce json
// @Success 200 {object} []service.GeofenceVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateGeofenceRequest true "Geofence Data"
// @Success 201 {object} service.GeofenceVO
...
// @Accept json
// @Produce json
// @Param request body service.ValidateQRRequest true "QR Data"
// @Success 200 {object} service.AccessLogVO
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetAccessHistoryResponse
...
// @Accept json
// @Produce json
// @Param request body service.LogAccessRequest true "Access Data"
// @Success 201 {object} service.AccessLogVO
...
// @Success 200 {object} []service.AccessPermissionVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateAccessPermissionRequest true "Permission Data"
// @Success 201 {object} service.AccessPermissionVO
...
// @Accept json
// @Produce json
// @Success 200 {object} []service.QuickActionVO
...
// @Success 200 {object} service.TranscriptVO
...
// @Success 200 {object} service.KRSVO
...
// @Accept json
// @Produce json
// @Success 200 {object} []service.BimbinganVO
...
// @Success 201 {object} service.FileVO
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetFilesResponse
...
// @Success 200 {object} service.FileVO
...
// @Param limit query int false "Limit"
// @Success 200 {object} service.GlobalSearchResponse
...
// @Success 200 {object} service.AttendanceReportVO
...
// @Produce json
// @Param semester query string false "Semester"
// @Success 200 {object} service.AcademicReportVO
...
// @Success 200 {object} service.CourseReportVO
...
// @Success 200 {object} service.DailyReportVO
...
// @Accept json
// @Produce json
// @Success 200 {object} []service.StudyProgramVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateStudyProgramRequest true "Data"
// @Success 201 {object} service.StudyProgramVO
...
// @Produce json
// @Param id path string true "ID"
// @Param request body service.UpdateStudyProgramRequest true "Data"
// @Success 200 {object} service.StudyProgramVO
...
// @Accept json
// @Produce json
// @Success 200 {object} []service.AcademicPeriodVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateAcademicPeriodRequest true "Data"
// @Success 201 {object} service.AcademicPeriodVO
...
// @Accept json
// @Produce json
// @Success 200 {object} []service.RoomVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateRoomRequest true "Data"
// @Success 201 {object} service.RoomVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateLeaveRequestRequest true "Leave Data"
// @Success 201 {object} service.LeaveRequestVO
...
// @Produce json
// @Param page query int false "Page"
// @Success 200 {object} service.GetLeaveRequestsResponse
...
// @Param request body service.ApproveLeaveRequestRequest true "Approve Data"
// @Success 200 {object} service.LeaveRequestVO
...
// @Accept json
// @Produce json
// @Param request body service.CreateLeaveQuotaRequest true "Quota Data"
// @Success 201 {object} service.LeaveQuotaVO
